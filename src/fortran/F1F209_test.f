...
*      implicit none
!       integer iq,iw
!       real*8 q2,w2,F1n,F2n,r,F1p,F2p,F1d,F2d,F1c,F2c,A,Z
!       real*8 f1dqe, f2dqe, nu, x, am, F1be, F2be,rbe
      
*     real*8 q2,w2,F1n,F2n,r,A,Z, am
      
*    am=0.9383
*     read(*,*) Z,A,q2,w2
*      call f1f2in09(Z, A, q2, w2, F1n, F2n,r)
*      write(6,'(3f9.6)') F1n, F2n, r
...
!         write(6,'(6f7.3)') q2,w2,x,f2n,f1n,r
!        enddo
! 	write(6,'(/)') 
!       enddo
! !       do iq=1,3
...
!       data XX/-3.000,-2.571,-2.143,-1.714,-1.286,-0.857,
!      >              -0.429, 0.000, 0.429, 0.857, 1.286, 1.714, 
!      >               2.143, 2.571, 3.000/
!       data fy/0.0019, 0.0063, 0.0172, 0.0394, 0.0749, 0.1186, 
